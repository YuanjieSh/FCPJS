...
parser.add_argument("--method", default="FCP_CS", type=str)
...
parser.add_argument("--sketch_method", default="histogram", type=str)
...
parser.add_argument('--num_sketch', default=1000, type=int, help='Number of global samples after sketch')
...
def main():
    ...
    client_data, client_indices = prepare_or_load_client_data(softmax_scores, labels, metadata, args.dataset, dataset_path, args.num_clients, partition_type, seed=1)
    
    client_feature = split_features_by_client(feature, client_indices)
    ...
    for seed in tqdm(range(args.splits)):
        ...
        client_scores = compute_conformal_scores_all_clients_3(client_data, seed, args.score, args, client_feature)
        ...
        q = weighted_scores_3(client_scores, args)

        (coverages, sizes) = global_conformal(global_test_scores, global_test_labels, q, client_scores, result_csv)
